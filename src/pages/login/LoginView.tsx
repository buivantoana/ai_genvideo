        ...
        <Background>
            <FormBox>
                ...
                <Typography variant="body2" color="#ccc" mb={3}>
                    Hôm nay là một ngày mới. Đó là ngày của bạn.<br />
                    Đăng nhập để bắt đầu quản lý các dự án của bạn.
                </Typography>
                <Typography color='#BCBCE0' fontWeight={"500"}>Tên đăng nhập</Typography>
                <StyledTextField
                    label="Tên đăng nhập"
                    ...
                    margin="normal"
                />
                <Typography color='#BCBCE0' fontWeight={"500"}>Mật khẩu</Typography>
                <StyledTextField
                    label="Mật khẩu"
                ...
                <Box textAlign="right" mt={1} mb={3}>
                    <Link href="#" underline="hover" sx={{ fontSize: '0.875rem', color: '#aaa' }}>
                        Quên mật khẩu
                    </Link>
                </Box>
